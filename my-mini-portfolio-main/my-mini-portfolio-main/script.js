...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const twitterLogo = document.querySelector('img[alt="twitter logo"]');
  const upworkLogo = document.querySelector('img[alt="upwork logo"]');
  const emailLogo = document.querySelector('img[alt="email logo"]');

  const lightLogos = {
    github: "assets/github_light.png",
    twitter: "assets/twitter_light.png",
    email: "assets/email_light.png",
    upwork: "assets/upwork_light.png",
    theme: "assets/theme_light.png",
  };

  const darkLogos = {
    github: "assets/github_dark.png",
    twitter: "assets/twitter_dark.png",
    email: "assets/email_dark.png",
    upwork: "assets/upwork_dark.png",
    theme: "assets/theme_dark.png",
  };

  function setTheme(isDark) {
    githubLogo.src = isDark ? darkLogos.github : lightLogos.github;
    twitterLogo.src = isDark ? darkLogos.twitter : lightLogos.twitter;
    emailLogo.src = isDark ? darkLogos.email : lightLogos.email;
    upworkLogo.src = isDark ? darkLogos.upwork : lightLogos.upwork;
